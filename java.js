...
/* mood toggle */
const moodIcon = document.querySelector('img[src="images/mood.png"]') || document.querySelector('.mood-icon');
const modeImageMap = {
    'app.png': 'appb.png',
    'bar.png': 'barb.png',
    'chat.png': 'chatb.png',
...
function updateModeImages(isLightMode) {
    document.querySelectorAll('img').forEach(img => {
        ...
        if (isLightMode && modeImageMap[filename]) {
            img.src = `images/${modeImageMap[filename]}`;
        } else if (!isLightMode && lightToDarkMap[filename]) {
            img.src = `images/${lightToDarkMap[filename]}`;
        }
    });
}
